...
async function isZkSyncChain(chain) {
  ...
  if (chain.id === 324 || chain.id === 300 || chain.id === 302 || chain.id === 11124 || chain.id === 282 || chain.id === 388 || chain.id === 4654 || chain.id === 333271 || chain.id === 37111) {
    return true;
  }
  try {
  ...
  const account = {
    ...
    async signMessage({ message }) {
      const [{ isContractDeployed: isContractDeployed2 }, { readContract: readContract2 }, { encodeAbiParameters: encodeAbiParameters2 }, { hashMessage }, { checkContractWalletSignature }] = await Promise.all([
        import("./is-contract-deployed-KL7NQP2E.js"),
        import("./read-contract-HOL5QHH7.js"),
        import("./encodeAbiParameters-JX45EQWK.js"),
        import("./hashMessage-FVKH3X4F.js"),
        import("./checkContractWalletSignature-NU3SQA55.js")
      ]);
    ...
    async signTypedData(_typedData) {
      ...
      const [{ isContractDeployed: isContractDeployed2 }, { readContract: readContract2 }, { encodeAbiParameters: encodeAbiParameters2 }, { checkContractWalletSignedTypedData }] = await Promise.all([
        ...
        import("./read-contract-HOL5QHH7.js"),
        import("./encodeAbiParameters-JX45EQWK.js"),
        import("./checkContractWalletSignedTypedData-CY6KOZZC.js")
      ]);
...
async function _deployAccount(args) {
  ...
  const [{ sendTransaction }, { prepareTransaction }] = await Promise.all([
    import("./send-transaction-RWWJJR3F.js"),
...
//# sourceMappingURL=chunk-7ZR523FV.js.map
