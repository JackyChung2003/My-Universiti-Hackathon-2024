...
async function createWalletConnectClient(options) {
  ...
  walletConnectClient.on("session_proposal", async (event) => {
    const { onSessionProposal } = await import("./session-proposal-W3YERYJP.js");
  ...
  walletConnectClient.on("session_request", async (event) => {
    const { fulfillRequest } = await import("./session-request-A2B4HMLI.js");
...
//# sourceMappingURL=chunk-O62WG7KZ.js.map
