...
function coinbaseWalletSDK(args) {
  ...
  return {
    ...
    autoConnect: async (options) => {
      const { autoConnectCoinbaseWalletSDK } = await import("./coinbaseWebSDK-QCRBDVTL.js");
    ...
    connect: async (options) => {
      const { connectCoinbaseWalletSDK } = await import("./coinbaseWebSDK-QCRBDVTL.js");
      const provider = await args.providerFactory();
...
function ecosystemWallet(...args) {
  ...
  return createInAppWallet({
    ...
    connectorFactory: async (client) => {
      const { InAppWebConnector } = await import("./web-connector-27VQI7V7.js");
      ...
      const wallet = {
        ...
        autoConnect: async (options) => {
          ...
          if (id !== "walletConnect" && injectedProvider(id)) {
            const { autoConnectInjectedWallet } = await import("./injected-BR47NRIS.js");
          ...
          if (options && "client" in options) {
            const { autoConnectWC } = await import("./controller-3Z2DUKGJ.js");
        ...
        connect: async (options) => {
          async function wcConnect(wcOptions) {
            const { connectWC } = await import("./controller-3Z2DUKGJ.js");
          ...
          if (injectedProvider(id) && !forceWalletConnectOption) {
            const { connectInjectedWallet } = await import("./injected-BR47NRIS.js");
...
//# sourceMappingURL=chunk-U4UBDLYH.js.map
