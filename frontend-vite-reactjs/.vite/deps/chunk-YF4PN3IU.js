...
import {
  getProfiles
} from "./chunk-ZWZYNOWR.js";
import {
  getNFT
} from "./chunk-Y2OH5VFN.js";
import {
  getNFT as getNFT2
} from "./chunk-DFKWXPWB.js";
import {
  getCurrencyMetadata
...
import {
  ...
  __rest,
  __spreadArray
} from "./chunk-ZQKVOPRN.js";
import {
  deleteConnectParamsFromStorage
} from "./chunk-EEJIPBWR.js";
import {
  isEcosystemWallet
} from "./chunk-SCPJC5TL.js";
import {
  smartWallet
} from "./chunk-T6NEEJUP.js";
import {
  isInAppWallet
} from "./chunk-IV4HHYDT.js";
import {
  ethereum
  ...
  useQueries({
    queries: wallets.filter((w) => w.id === COINBASE || w.id === "inApp" || isEcosystemWallet(w.id)).map((w) => ({
      ...
      queryFn: async () => {
        ...
        switch (true) {
          case COINBASE === w.id: {
            const { getCoinbaseWebProvider } = await import("./coinbaseWebSDK-QCRBDVTL.js");
            await getCoinbaseWebProvider(w.getConfig());
            return true;
          }
          case "inApp" === w.id: {
            const [{ InAppWebConnector }, { getOrCreateInAppWalletConnector }] = await Promise.all([
              import("./web-connector-27VQI7V7.js"),
              import("./in-app-core-DIRB32LT.js")
            ]);
...
function BuyTxHistoryButton(props) {
  ...
  return (0, import_jsx_runtime30.jsxs)(TxButton, { onClick: props.onClick, variant: "secondary", fullWidth: true, style: {
    ...
    flexDirection: "column",
    justifyContent: "center"
  }, children: [(0, import_jsx_runtime30.jsx)(Container, { flex: "row", gap: "xs", center: "y", style: {
...
function PayTxHistoryList(props) {
  ...
  return (0, import_jsx_runtime31.jsxs)(Container, { scrollY: true, flex: "column", fullHeight: true, style: {
    width: "100%",
    minHeight: "250px",
    maxHeight: "370px",
    paddingBottom: spacing.lg
  }, children: [(0, import_jsx_runtime31.jsxs)(Container, { flex: "column", gap: "xs", expand: true, children: [noTransactions && !isLoading && (0, import_jsx_runtime31.jsxs)(Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", style: {
    minHeight: "250px"
  }, children: [(0, import_jsx_runtime31.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime31.jsx)(Text, { children: "No Transactions" })] }), noTransactions && isLoading && (0, import_jsx_runtime31.jsx)(Container, { flex: "row", center: "both", style: {
    minHeight: "250px"
  }, children: (0, import_jsx_runtime31.jsx)(Spinner, { size: "xl", color: "accentText" }) }), txInfosToShow.length > 0 && (0, import_jsx_runtime31.jsx)(Container, { animate: "fadein", flex: "column", gap: "xs", children: txInfosToShow.map((txInfo) => {
    var _a;
    return (0, import_jsx_runtime31.jsx)(BuyTxHistoryButton, { txInfo, client: props.client, onClick: () => {
      props.onSelectTx(txInfo);
    } }, txInfo.type === "swap" ? (_a = txInfo.status.source) == null ? void 0 : _a.transactionHash : txInfo.status.intentId);
  }) }), isLoading && txInfosToShow.length > 0 && (0, import_jsx_runtime31.jsxs)(import_jsx_runtime31.Fragment, { children: [(0, import_jsx_runtime31.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), (0, import_jsx_runtime31.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), (0, import_jsx_runtime31.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight })] })] }), pagination && !hidePagination && (0, import_jsx_runtime31.jsx)(Container, { py: "md", children: (0, import_jsx_runtime31.jsxs)("div", { style: {
    display: "grid",
    gridTemplateColumns: "1fr 1fr",
    gap: spacing.sm
  }, children: [(0, import_jsx_runtime31.jsxs)(Button, { variant: "outline", gap: "xs", disabled: pageIndex === 0, "data-disabled": pageIndex === 0, style: {
    fontSize: fontSize.sm,
    paddingBlock: spacing.sm
  }, onClick: () => {
    setPageIndex((prev) => prev - 1);
  }, children: [(0, import_jsx_runtime31.jsx)(ArrowRightIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    transform: "rotate(180deg)"
  } }), "Prev"] }), (0, import_jsx_runtime31.jsxs)(Button, { variant: "outline", gap: "xs", disabled: !pagination.hasNextPage, "data-disabled": !pagination.hasNextPage, style: {
    fontSize: fontSize.sm,
    paddingBlock: spacing.sm
  }, onClick: () => {
    setPageIndex((prev) => prev + 1);
  }, children: ["Next", (0, import_jsx_runtime31.jsx)(ArrowRightIcon, { width: iconSize.sm, height: iconSize.sm })] })] }) })] });
}
...
function TokenInfoRow(props) {
  ...
  return (0, import_jsx_runtime32.jsxs)(Container, { flex: "row", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime32.jsx)(Text, { size: "sm", children: props.label }), (0, import_jsx_runtime32.jsxs)(Container, { flex: "column", gap: "xxs", style: {
    alignItems: "flex-end"
  }, children: [(0, import_jsx_runtime32.jsxs)(Container, { flex: "row", gap: "xs", center: "y", children: [(0, import_jsx_runtime32.jsx)(PayTokenIcon, { chain: chainObj, size: "sm", token: {
    address: props.tokenAddress
  }, client: props.client }), (0, import_jsx_runtime32.jsxs)(Text, { color: "primaryText", children: [formatNumber(Number(props.tokenAmount), 6), " ", props.tokenSymbol] })] }), (0, import_jsx_runtime32.jsx)(Text, { size: "sm", children: name })] })] });
}
...
var CADIcon = (props) => {
  return (0, import_jsx_runtime33.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime33.jsx)("mask", { id: "a", children: (0, import_jsx_runtime33.jsx)("circle", { cx: "256", cy: "256", r: "256", fill: "#fff" }) }), (0, import_jsx_runtime33.jsxs)("g", { mask: "url(#a)", children: [(0, import_jsx_runtime33.jsx)("path", { fill: "#d80027", d: "M0 0v512h144l112-64 112 64h144V0H368L256 64 144 0Z" }), (0, import_jsx_runtime33.jsx)("path", { fill: "#eee", d: "M144 0h224v512H144Z" }), (0, import_jsx_runtime33.jsx)("path", { fill: "#d80027", d: "m301 289 44-22-22-11v-22l-45 22 23-44h-23l-22-34-22 33h-23l23 45-45-22v22l-22 11 45 22-12 23h45v33h22v-33h45z" })] })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/EURIcon.js
var import_jsx_runtime34 = __toESM(require_jsx_runtime(), 1);
var EURIcon = (props) => {
  return (0, import_jsx_runtime34.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime34.jsx)("mask", { id: "a", children: (0, import_jsx_runtime34.jsx)("circle", { cx: "256", cy: "256", r: "256", fill: "#fff" }) }), (0, import_jsx_runtime34.jsxs)("g", { mask: "url(#a)", children: [(0, import_jsx_runtime34.jsx)("path", { fill: "#0052b4", d: "M0 0h512v512H0z" }), (0, import_jsx_runtime34.jsx)("path", { fill: "#ffda44", d: "m256 100.2 8.3 25.5H291l-21.7 15.7 8.3 25.6-21.7-15.8-21.7 15.8 8.3-25.6-21.7-15.7h26.8zm-110.2 45.6 24 12.2 18.9-19-4.2 26.5 23.9 12.2-26.5 4.2-4.2 26.5-12.2-24-26.5 4.3 19-19zM100.2 256l25.5-8.3V221l15.7 21.7 25.6-8.3-15.8 21.7 15.8 21.7-25.6-8.3-15.7 21.7v-26.8zm45.6 110.2 12.2-24-19-18.9 26.5 4.2 12.2-23.9 4.2 26.5 26.5 4.2-24 12.2 4.3 26.5-19-19zM256 411.8l-8.3-25.5H221l21.7-15.7-8.3-25.6 21.7 15.8 21.7-15.8-8.3 25.6 21.7 15.7h-26.8zm110.2-45.6-24-12.2-18.9 19 4.2-26.5-23.9-12.2 26.5-4.2 4.2-26.5 12.2 24 26.5-4.3-19 19zM411.8 256l-25.5 8.3V291l-15.7-21.7-25.6 8.3 15.8-21.7-15.8-21.7 25.6 8.3 15.7-21.7v26.8zm-45.6-110.2-12.2 24 19 18.9-26.5-4.2-12.2 23.9-4.2-26.5-26.5-4.2 24-12.2-4.3-26.5 19 19z" })] })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/GBPIcon.js
var import_jsx_runtime35 = __toESM(require_jsx_runtime(), 1);
var GBPIcon = (props) => {
  return (0, import_jsx_runtime35.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", id: "Layer_1", x: "0px", y: "0px", width: props.size, height: props.size, viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime35.jsx)("circle", { fill: "#F0F0F0", cx: "256", cy: "256", r: "256" }), (0, import_jsx_runtime35.jsxs)("g", { children: [(0, import_jsx_runtime35.jsx)("path", { fill: "#0052B4", d: "M52.92,100.142c-20.109,26.163-35.272,56.318-44.101,89.077h133.178L52.92,100.142z" }), (0, import_jsx_runtime35.jsx)("path", { fill: "#0052B4", d: "M503.181,189.219c-8.829-32.758-23.993-62.913-44.101-89.076l-89.075,89.076H503.181z" }), (0, import_jsx_runtime35.jsx)("path", { fill: "#0052B4", d: "M8.819,322.784c8.83,32.758,23.993,62.913,44.101,89.075l89.074-89.075L8.819,322.784L8.819,322.784   z" }), (0, import_jsx_runtime35.jsx)("path", { fill: "#0052B4", d: "M411.858,52.921c-26.163-20.109-56.317-35.272-89.076-44.102v133.177L411.858,52.921z" }), (0, import_jsx_runtime35.jsx)("path", { fill: "#0052B4", d: "M100.142,459.079c26.163,20.109,56.318,35.272,89.076,44.102V370.005L100.142,459.079z" }), (0, import_jsx_runtime35.jsx)("path", { fill: "#0052B4", d: "M189.217,8.819c-32.758,8.83-62.913,23.993-89.075,44.101l89.075,89.075V8.819z" }), (0, import_jsx_runtime35.jsx)("path", { fill: "#0052B4", d: "M322.783,503.181c32.758-8.83,62.913-23.993,89.075-44.101l-89.075-89.075V503.181z" }), (0, import_jsx_runtime35.jsx)("path", { fill: "#0052B4", d: "M370.005,322.784l89.075,89.076c20.108-26.162,35.272-56.318,44.101-89.076H370.005z" })] }), (0, import_jsx_runtime35.jsxs)("g", { children: [(0, import_jsx_runtime35.jsx)("path", { fill: "#D80027", d: "M509.833,222.609h-220.44h-0.001V2.167C278.461,0.744,267.317,0,256,0   c-11.319,0-22.461,0.744-33.391,2.167v220.44v0.001H2.167C0.744,233.539,0,244.683,0,256c0,11.319,0.744,22.461,2.167,33.391   h220.44h0.001v220.442C233.539,511.256,244.681,512,256,512c11.317,0,22.461-0.743,33.391-2.167v-220.44v-0.001h220.442   C511.256,278.461,512,267.319,512,256C512,244.683,511.256,233.539,509.833,222.609z" }), (0, import_jsx_runtime35.jsx)("path", { fill: "#D80027", d: "M322.783,322.784L322.783,322.784L437.019,437.02c5.254-5.252,10.266-10.743,15.048-16.435   l-97.802-97.802h-31.482V322.784z" }), (0, import_jsx_runtime35.jsx)("path", { fill: "#D80027", d: "M189.217,322.784h-0.002L74.98,437.019c5.252,5.254,10.743,10.266,16.435,15.048l97.802-97.804   V322.784z" }), (0, import_jsx_runtime35.jsx)("path", { fill: "#D80027", d: "M189.217,189.219v-0.002L74.981,74.98c-5.254,5.252-10.266,10.743-15.048,16.435l97.803,97.803   H189.217z" }), (0, import_jsx_runtime35.jsx)("path", { fill: "#D80027", d: "M322.783,189.219L322.783,189.219L437.02,74.981c-5.252-5.254-10.743-10.266-16.435-15.047   l-97.802,97.803V189.219z" })] })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/JPYIcon.js
var import_jsx_runtime36 = __toESM(require_jsx_runtime(), 1);
var JPYIcon = (props) => {
  return (0, import_jsx_runtime36.jsx)("svg", { width: props.size, height: props.size, viewBox: "0 0 32 32", xmlns: "http://www.w3.org/2000/svg", role: "presentation", children: (0, import_jsx_runtime36.jsxs)("g", { fill: "none", "fill-rule": "evenodd", children: [(0, import_jsx_runtime36.jsx)("circle", { cx: "16", cy: "16", fill: "#a81b1b", r: "16" }), (0, import_jsx_runtime36.jsx)("path", { d: "M17.548 18.711v1.878h5.063v2.288h-5.063V25.5h-3.096v-2.623H9.389v-2.288h5.063v-1.878H9.389v-2.288h4.171L7.5 7.5h3.752l4.8 7.534L20.853 7.5H24.5l-6.086 8.923h4.197v2.288z", fill: "#ffffff" })] }) });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/USDIcon.js
var import_jsx_runtime37 = __toESM(require_jsx_runtime(), 1);
var USDIcon = (props) => {
  return (0, import_jsx_runtime37.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", width: props.size, height: props.size, x: "0px", y: "0px", viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime37.jsx)("circle", { fill: "#F0F0F0", cx: "256", cy: "256", r: "256" }), (0, import_jsx_runtime37.jsxs)("g", { children: [(0, import_jsx_runtime37.jsx)("path", { fill: "#D80027", d: "M244.87,256H512c0-23.106-3.08-45.49-8.819-66.783H244.87V256z" }), (0, import_jsx_runtime37.jsx)("path", { fill: "#D80027", d: "M244.87,122.435h229.556c-15.671-25.572-35.708-48.175-59.07-66.783H244.87V122.435z" }), (0, import_jsx_runtime37.jsx)("path", { fill: "#D80027", d: "M256,512c60.249,0,115.626-20.824,159.356-55.652H96.644C140.374,491.176,195.751,512,256,512z" }), (0, import_jsx_runtime37.jsx)("path", { fill: "#D80027", d: "M37.574,389.565h436.852c12.581-20.529,22.338-42.969,28.755-66.783H8.819   C15.236,346.596,24.993,369.036,37.574,389.565z" })] }), (0, import_jsx_runtime37.jsx)("path", { fill: "#0052B4", d: "M118.584,39.978h23.329l-21.7,15.765l8.289,25.509l-21.699-15.765L85.104,81.252l7.16-22.037  C73.158,75.13,56.412,93.776,42.612,114.552h7.475l-13.813,10.035c-2.152,3.59-4.216,7.237-6.194,10.938l6.596,20.301l-12.306-8.941  c-3.059,6.481-5.857,13.108-8.372,19.873l7.267,22.368h26.822l-21.7,15.765l8.289,25.509l-21.699-15.765l-12.998,9.444  C0.678,234.537,0,245.189,0,256h256c0-141.384,0-158.052,0-256C205.428,0,158.285,14.67,118.584,39.978z M128.502,230.4  l-21.699-15.765L85.104,230.4l8.289-25.509l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822l-21.7,15.765L128.502,230.4z   M120.213,130.317l8.289,25.509l-21.699-15.765l-21.699,15.765l8.289-25.509l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822  L120.213,130.317z M220.328,230.4l-21.699-15.765L176.93,230.4l8.289-25.509l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822  l-21.7,15.765L220.328,230.4z M212.039,130.317l8.289,25.509l-21.699-15.765l-21.699,15.765l8.289-25.509l-21.7-15.765h26.822  l8.288-25.509l8.288,25.509h26.822L212.039,130.317z M212.039,55.743l8.289,25.509l-21.699-15.765L176.93,81.252l8.289-25.509  l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822L212.039,55.743z" })] });
};
...
var UnknownCurrencyIcon = (props) => {
  return (0, import_jsx_runtime38.jsx)(RadiobuttonIcon, { width: props.size, height: props.size });
};
...
function OnRampTxDetailsTable(props) {
  ...
  return (0, import_jsx_runtime39.jsxs)("div", { children: [(0, import_jsx_runtime39.jsxs)(Container, { flex: "row", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime39.jsx)(Text, { children: "Pay" }), (0, import_jsx_runtime39.jsx)(Container, { flex: "column", gap: "xxs", style: {
    alignItems: "flex-end"
  }, children: (0, import_jsx_runtime39.jsxs)(Container, { flex: "row", gap: "xs", center: "y", children: [(0, import_jsx_runtime39.jsx)(currencyMeta.icon, { size: iconSize.sm }), (0, import_jsx_runtime39.jsxs)(Text, { color: "primaryText", children: [formatNumber(Number(props.fiat.amount), 2), " ", props.fiat.currencySymbol] })] }) })] }), lineSpacer, (0, import_jsx_runtime39.jsx)(TokenInfoRow, { chainId: props.token.chainId, client: props.client, label: "Receive", tokenAmount: props.token.amount, tokenSymbol: props.token.symbol, tokenAddress: props.token.address }), props.statusMeta && (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [lineSpacer, (0, import_jsx_runtime39.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime39.jsx)(Text, { children: "Status" }), (0, import_jsx_runtime39.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime39.jsx)(Text, { color: props.statusMeta.color, children: props.statusMeta.text }) })] })] }), lineSpacer, onrampTxHash && ((_c = (_b = onRampExplorers.explorers) == null ? void 0 : _b[0]) == null ? void 0 : _c.url) && (0, import_jsx_runtime39.jsxs)(import_jsx_runtime39.Fragment, { children: [(0, import_jsx_runtime39.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime39.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${onRampExplorers.explorers[0].url || ""}/tx/${onrampTxHash}`, target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm
  }, children: ["View on Explorer", (0, import_jsx_runtime39.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] })] })] });
}
...
function StepIcon(props) {
  return (0, import_jsx_runtime40.jsx)(Container, { flex: "row", center: "both", color: props.isDone ? "success" : props.isActive ? "accentText" : "secondaryText", children: (0, import_jsx_runtime40.jsx)(Circle, { children: props.isDone ? (0, import_jsx_runtime40.jsx)(CheckIcon, { width: iconSize.sm, height: iconSize.sm }) : (0, import_jsx_runtime40.jsx)(PulsingDot, { "data-active": props.isActive }) }) });
}
function Step(props) {
  return (0, import_jsx_runtime40.jsxs)(Container, { flex: "row", center: "y", gap: "xs", style: {
    fontSize: fontSize.sm
  }, color: props.isDone ? "success" : props.isActive ? "accentText" : "secondaryText", children: [(0, import_jsx_runtime40.jsx)(StepIcon, { isDone: props.isDone, isActive: props.isActive }), props.label] });
}
...
function FiatSteps(props) {
  ...
  const onRampTokenInfo = (0, import_jsx_runtime41.jsx)("div", { children: (0, import_jsx_runtime41.jsxs)(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(onRampTokenAmount), 6), " ", (0, import_jsx_runtime41.jsx)(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "sm", inline: true })] }) });
  const fiatIcon = (0, import_jsx_runtime41.jsx)(currency.icon, { size: iconSize.sm });
  const onRampTokenIcon = (0, import_jsx_runtime41.jsx)(PayTokenIcon, { token: onRampToken, chain: onRampChain, size: "sm", client: props.client });
  const toTokenIcon = (0, import_jsx_runtime41.jsx)(PayTokenIcon, { token: toToken, chain: toChain, size: "sm", client: props.client });
  const onRampChainInfo = (0, import_jsx_runtime41.jsx)(Text, { size: "xs", children: onRampName.name });
  const partialSuccessToTokenInfo = ((_a = props.status) == null ? void 0 : _a.status) === "CRYPTO_SWAP_FALLBACK" && props.status.destination ? (0, import_jsx_runtime41.jsxs)("div", { children: [(0, import_jsx_runtime41.jsxs)(Text, { color: "secondaryText", size: "sm", inline: true, style: {
    textDecoration: "line-through"
  }, children: [formatNumber(Number(toTokenAmount), 6), " ", (0, import_jsx_runtime41.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "secondaryText" })] }), " ", (0, import_jsx_runtime41.jsxs)(Text, { color: "danger", size: "sm", inline: true, children: [formatNumber(Number(props.status.destination.amount), 6), " ", (0, import_jsx_runtime41.jsx)(TokenSymbol, { token: {
  ...
  const toTokenInfo = partialSuccessToTokenInfo || (0, import_jsx_runtime41.jsxs)(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(toTokenAmount), 6), (0, import_jsx_runtime41.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true })] });
  const partialSuccessToChainInfo = ((_b = props.status) == null ? void 0 : _b.status) === "CRYPTO_SWAP_FALLBACK" && props.status.destination && props.status.destination.token.chainId !== props.status.quote.toToken.chainId ? (0, import_jsx_runtime41.jsxs)("div", { children: [(0, import_jsx_runtime41.jsx)(Text, { size: "xs", inline: true, style: {
    textDecoration: "line-through"
  }, children: toChainName.name }), " ", (0, import_jsx_runtime41.jsx)(Text, { size: "xs", inline: true, children: destinationName.name })] }) : null;
  const toTokehChainInfo = partialSuccessToChainInfo || (0, import_jsx_runtime41.jsx)(Text, { size: "xs", children: toChainName.name });
  ...
  return (0, import_jsx_runtime41.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime41.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime41.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime41.jsx)(PaymentStep, { title: (0, import_jsx_runtime41.jsxs)(Text, { color: "primaryText", size: "md", children: ["Get", " ", (0, import_jsx_runtime41.jsx)(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "md", inline: true }), " ", "with ", props.partialQuote.fromCurrencySymbol] }), step: 1, from: {
    icon: fiatIcon,
    primaryText: (0, import_jsx_runtime41.jsxs)(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(fromCurrencyAmount), 6), " ", fromCurrencySymbol] })
  }, to: {
  ...
  } : void 0 }), (0, import_jsx_runtime41.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime41.jsx)(PaymentStep, { title: (0, import_jsx_runtime41.jsxs)(Text, { color: "primaryText", size: "md", children: ["Convert", " ", (0, import_jsx_runtime41.jsx)(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "md", inline: true }), " ", "to ", (0, import_jsx_runtime41.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "md", inline: true })] }), step: 2, from: {
    icon: onRampTokenIcon,
    primaryText: onRampTokenInfo,
    secondaryText: onRampChainInfo
  }, to: {
  ...
  } : void 0 }), isPartialSuccess && props.status && props.status.status !== "NOT_FOUND" && props.status.source && props.status.destination && (0, import_jsx_runtime41.jsxs)(import_jsx_runtime41.Fragment, { children: [(0, import_jsx_runtime41.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime41.jsxs)(Text, { color: "danger", size: "sm", center: true, children: ["Expected ", (_l = props.status.source) == null ? void 0 : _l.token.symbol, ", Got", " ", (_m = props.status.destination) == null ? void 0 : _m.token.symbol, " instead"] }), (0, import_jsx_runtime41.jsx)(Spacer, { y: "sm" })] }), showContinueBtn && (0, import_jsx_runtime41.jsxs)(import_jsx_runtime41.Fragment, { children: [(0, import_jsx_runtime41.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime41.jsx)(Button, { variant: "accent", onClick: props.onContinue, fullWidth: true, children: "Continue" })] })] });
}
function PaymentStep(props) {
  return (0, import_jsx_runtime41.jsxs)(StepContainer, { state: props.state, children: [(0, import_jsx_runtime41.jsxs)(Text, { size: "sm", children: ["Step ", props.step] }), (0, import_jsx_runtime41.jsx)(Spacer, { y: "sm" }), props.title, (0, import_jsx_runtime41.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime41.jsx)(Line, {}), (0, import_jsx_runtime41.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime41.jsx)(PaymentSubStep, { ...props.from }), (0, import_jsx_runtime41.jsxs)(Container, { color: "borderColor", style: {
    paddingLeft: "18px",
    position: "relative",
    marginBlock: "3px"
  }, children: [(0, import_jsx_runtime41.jsx)("div", { style: {
    height: "18px",
    width: "2px",
    backgroundColor: "currentColor",
    transform: "translateX(-50%)"
  } }), (0, import_jsx_runtime41.jsx)(TriangleDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    position: "absolute",
    bottom: "0",
    transform: "translate(-50%, 50%)"
  } })] }), (0, import_jsx_runtime41.jsx)(PaymentSubStep, { ...props.to }), props.explorer && (0, import_jsx_runtime41.jsxs)(import_jsx_runtime41.Fragment, { children: [(0, import_jsx_runtime41.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime41.jsxs)(ButtonLink, { variant: "outline", fullWidth: true, href: props.explorer.url, style: {
    fontSize: fontSize.xs,
    padding: spacing.xs
  }, gap: "xxs", target: "_blank", children: [props.explorer.label, (0, import_jsx_runtime41.jsx)(ExternalLinkIcon, { width: iconSize.xs, height: iconSize.xs })] })] })] });
}
function PaymentSubStep(props) {
  return (0, import_jsx_runtime41.jsxs)(Container, { flex: "row", gap: "sm", center: "y", style: {
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime41.jsx)(Container, { p: "xs", borderColor: "borderColor", flex: "row", center: "both", style: {
    borderStyle: "solid",
    borderWidth: "1.5px",
    borderRadius: radius.lg
  }, children: props.icon }), (0, import_jsx_runtime41.jsxs)(Container, { flex: "column", gap: "xxs", children: [props.primaryText, props.secondaryText] })] });
}
function StepContainer(props) {
  ...
  return (0, import_jsx_runtime41.jsxs)(Container, { bg: "tertiaryBg", borderColor: color === "success" ? "borderColor" : color, py: "sm", px: "md", style: {
    borderRadius: radius.lg,
    alignItems: "flex-start",
    borderWidth: "1px",
    borderStyle: "solid",
    position: "relative"
  }, children: [props.children, (0, import_jsx_runtime41.jsxs)("div", { style: {
    position: "absolute",
    right: spacing.sm,
    top: spacing.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center"
  }, children: [props.state && text && (0, import_jsx_runtime41.jsx)(Text, { size: "sm", color, children: text }), (props.state === "actionRequired" || props.state === "completed") && (0, import_jsx_runtime41.jsx)(StepIcon, { isActive: props.state === "actionRequired", isDone: props.state === "completed" }), props.state === "pending" && (0, import_jsx_runtime41.jsx)(Spinner, { color: "accentText", size: "sm" }), props.state === "failed" && (0, import_jsx_runtime41.jsx)(Container, { color: "danger", flex: "row", center: "both", children: (0, import_jsx_runtime41.jsx)(Cross1Icon, { width: iconSize.sm, height: iconSize.sm }) })] })] });
}
...
function StepBar(props) {
  return (0, import_jsx_runtime42.jsx)(Container, { bg: "tertiaryBg", flex: "row", style: {
    height: "8px",
    borderRadius: radius.lg
  }, children: (0, import_jsx_runtime42.jsx)(Container, { bg: "accentText", style: {
...
function SwapFeesRightAligned(props) {
  return (0, import_jsx_runtime43.jsx)(Container, { flex: "column", gap: "xs", style: {
    alignItems: "flex-end"
  }, children: props.quote.processingFees.map((fee) => {
    const feeAmount = formatNumber(Number(fee.amount), 6);
    return (0, import_jsx_runtime43.jsxs)(Container, { flex: "row", gap: "xxs", children: [(0, import_jsx_runtime43.jsxs)(Text, { color: "primaryText", size: "sm", children: [feeAmount === 0 ? "~" : "", feeAmount, " ", fee.token.symbol] }), (0, import_jsx_runtime43.jsxs)(Text, { color: "secondaryText", size: "sm", children: ["($", (fee.amountUSDCents / 100).toFixed(2), ")"] })] }, `${fee.token.chainId}_${fee.token.tokenAddress}_${feeAmount}`);
  }) });
}
...
var BuyScreen = (0, import_react34.lazy)(() => import("./BuyScreen-2EMDINZL.js"));
...
// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/ConnectModalContent.js
var AllWalletsUI = (0, import_react38.lazy)(() => import("./AllWalletsUI-L2MVY4YC.js"));
...
var InAppWalletConnectUI = (0, import_react40.lazy)(() => import("./InAppWalletConnectUI-XAASP7BU.js"));
...
function LinkedProfile({ profile, client }) {
  ...
  return (0, import_jsx_runtime64.jsxs)(MenuButton, { style: {
    ...
    borderRadius: "100%",
    overflow: "hidden"
  }, children: (0, import_jsx_runtime64.jsx)(Blobbie, { address: profile.details.address, size: 32 }) }) : (0, import_jsx_runtime64.jsx)(Img, { src: getWalletIcon(profile.type), width: iconSize.lg, height: iconSize.lg, loading: "eager", client }), (0, import_jsx_runtime64.jsxs)("div", { style: {
    display: "flex",
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  return transfer({
    ...
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals: decimals2 } = await import("./decimals-JBTFVKTH.js");
...
async function getTokenBalance(options) {
  ...
  if (tokenAddress) {
    const { getBalance } = await import("./getBalance-G4QVBXR2.js");
    return getBalance({
...
function useTokenInfo(options) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (tokenAddress) {
        const { getCurrencyMetadata: getCurrencyMetadata2 } = await import("./getCurrencyMetadata-URCTZXTE.js");
        const result2 = await getCurrencyMetadata2({
          contract: getContract({ client, chain, address: tokenAddress })
        });
        return result2;
      }
      const { getChainDecimals: getChainDecimals2, getChainNativeCurrencyName: getChainNativeCurrencyName2, getChainSymbol: getChainSymbol2 } = await import("./utils-NXPIH5YK.js");
...
var ModelViewer = (0, import_react45.lazy)(() => import("./ModelViewer-3DQOXIFX.js"));
...
function DetailsModal(props) {
  ...
  if (screen === "network-switcher") {
    ...
    content = (0, import_jsx_runtime81.jsx)(LazyBuyScreen, { title: locale.buy, isEmbed: false, client, onBack: () => setScreen("main"), supportedTokens: props.supportedTokens, connectLocale: locale, payOptions: ((_t = props.detailsModal) == null ? void 0 : _t.payOptions) || {
      mode: "fund_wallet"
...
function InAppWalletUserInfo(props) {
  ...
  const userInfoQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      const { getUserEmail, getUserPhoneNumber } = await import("./auth-6MII6P2U.js");
...
function WalletSwitcherDrawerContent(props) {
  ...
  const connectedWallets = useConnectedWallets();
  const hideConnectButton = !props.showAllWallets && ((_a = props.wallets) == null ? void 0 : _a.every((w) => connectedWallets.includes(w)));
  return (0, import_jsx_runtime99.jsxs)(Container, { children: [(0, import_jsx_runtime99.jsxs)(Container, { flex: "column", gap: "xs", children: [connectedWallets.filter((w) => {
    var _a2;
    return !((_a2 = props.hiddenWallets) == null ? void 0 : _a2.includes(w.id));
  }).map((w) => {
    var _a2;
...
function BuyScreenContent(props) {
  ...
  if (screen.id === "transfer-flow" && payer && activeAccount) {
    ...
    return (0, import_jsx_runtime100.jsx)(TransferFlow, { title: props.title, onBack: goBack, payer, client: props.client, chain: toChain, token: toToken, tokenAmount, receiverAddress, transactionMode: props.payOptions.mode === "transaction", payOptions, isEmbed: props.isEmbed, onDone, onTryAgain: () => {
      setScreen({
        id: "buy-with-crypto"
      });
    }, onSuccess: onSwapSuccess });
  ...
  }, children: [screen.id === "select-payment-method" && (0, import_jsx_runtime100.jsx)(PaymentMethodSelection, { mode: payOptions.mode, client, walletAddress: payer.account.address, walletType: payer.wallet.id, setScreen: (id) => setScreen({ id }) }), screen.id === "select-wallet" && (0, import_jsx_runtime100.jsx)(WalletSwitcherDrawerContent, { client, hiddenWallets: props.hiddenWallets, onSelect: (w) => {
    const chain = w.getChain();
    const account = w.getAccount();
    if (chain && account) {
      setPayer({
...
function PaymentMethodSelection(props) {
  return (0, import_jsx_runtime100.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime100.jsxs)(Container, { flex: "column", gap: "sm", children: [(0, import_jsx_runtime100.jsxs)(Button, { variant: "outline", bg: "tertiaryBg", onClick: () => {
    trackPayEvent({
...
//# sourceMappingURL=chunk-YF4PN3IU.js.map
