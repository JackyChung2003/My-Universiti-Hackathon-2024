...
async function getNFTAsset(options) {
  ...
  switch (true) {
    case erc721: {
      const { getNFT } = await import("./getNFT-KB36H3ML.js");
      return getNFT(options);
    }
    case erc1155: {
      const { getNFT } = await import("./getNFT-LZPOOSUJ.js");
      return getNFT(options);
    }
    default: {
...
//# sourceMappingURL=chunk-G7QU34LP.js.map
