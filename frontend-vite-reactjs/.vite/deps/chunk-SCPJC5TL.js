...
async function getWalletInfo(id, image) {
  if (isEcosystemWallet(id)) {
    const { getEcosystemWalletInfo } = await import("./get-ecosystem-wallet-info-M4262IAC.js");
  ...
  switch (id) {
    ...
    case "com.okex.wallet": {
      return image ? import("./image-7TE6IAEE.js").then((img) => img.default) : import("./com.okex-ZLLBNEZR.js").then((w) => w.wallet);
    }
    ...
    case "com.crypto": {
      return image ? import("./image-KXNIB5FT.js").then((img) => img.default) : import("./com-BXKPW26R.js").then((w) => w.wallet);
    }
    case "com.exodus": {
    ...
    case "app.walletnow": {
      return image ? import("./image-YFUELAZQ.js").then((img) => img.default) : import("./app-MAINDPKB.js").then((w) => w.wallet);
    }
    case "com.bitcoin": {
    ...
    case "com.coin98": {
      return image ? import("./image-EMALOCF3.js").then((img) => img.default) : import("./com-RXGESJXM.js").then((w) => w.wallet);
    }
    case "io.myabcwallet": {
    ...
    case "app.status": {
      return image ? import("./image-6UJZ3MRX.js").then((img) => img.default) : import("./app-G6NCTPAQ.js").then((w) => w.wallet);
    }
    case "io.enjin": {
    ...
    case "org.nitrogen": {
      return image ? import("./image-C2SKQDD6.js").then((img) => img.default) : import("./org-SM5TUO6A.js").then((w) => w.wallet);
    }
    ...
    case "io.tradestrike": {
      return image ? import("./image-WYZJZYGN.js").then((img) => img.default) : import("./io-4WBMEJTZ.js").then((w) => w.wallet);
    }
    case "cc.avacus": {
    ...
    case "com.brave.wallet": {
      return image ? import("./image-FMQV5CAX.js").then((img) => img.default) : import("./com.brave-EBRPFCMH.js").then((w) => w.wallet);
    }
    case "io.streakk": {
    ...
    case "com.tomi": {
      return image ? import("./image-ERC5MXLP.js").then((img) => img.default) : import("./com-F25Y2LKF.js").then((w) => w.wallet);
    }
    case "app.subwallet": {
    ...
    case "finance.plena": {
      return image ? import("./image-OCLQH6ET.js").then((img) => img.default) : import("./finance-3CMVPYVZ.js").then((w) => w.wallet);
    }
    case "com.wemix": {
    ...
    case "io.miraiapp": {
      return image ? import("./image-AKSCPOZE.js").then((img) => img.default) : import("./io-I5T7643E.js").then((w) => w.wallet);
    }
    case "io.kigo": {
    ...
    case "net.myrenegade": {
      return image ? import("./image-T4K2HHHO.js").then((img) => img.default) : import("./net-2L6MGXXA.js").then((w) => w.wallet);
    }
    case "io.ready": {
    ...
    case "finance.openwallet": {
      return image ? import("./image-TW36VKLS.js").then((img) => img.default) : import("./finance-ZVDEUAG2.js").then((w) => w.wallet);
    }
    ...
    case "com.walletconnect.com": {
      return image ? import("./image-GZN5KP3J.js").then((img) => img.default) : import("./com.walletconnect-TC275ST6.js").then((w) => w.wallet);
    }
...
//# sourceMappingURL=chunk-SCPJC5TL.js.map
